        ...
        <header style={{ textAlign: 'center', position: 'relative' }}>
          ...
          <div style={{ marginTop: 'var(--espacement-sm)' }}>
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-bordure rounded-lg text-sm text-brume-500 no-underline hover:text-action hover:border-action transition-all"
            >
